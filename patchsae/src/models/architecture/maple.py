"""
# Portions of this file are based on code from the “multimodal-prompt-learning” repository (MIT-licensed):
#     https://github.com/muzairkhattak/multimodal-prompt-learning/blob/main/trainers/maple.py
"""
