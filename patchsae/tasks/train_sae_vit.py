...
if __name__ == "__main__":
    ...
    parser.add_argument("--lr_scheduler_name", type=str,
                        default="constantwithwarmup")
    ...
    for block_layer in args.block_layers:
        ...
        scheduler = get_scheduler(
            args.lr_scheduler_name, optimizer=optimizer)
    ...
    print("Training complete for all SAEs.")
