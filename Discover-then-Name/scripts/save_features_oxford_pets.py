...
def build_dataset(root, preprocess):
    pstruct = os.path.join(root, "pets_structured")
    assert os.path.isdir(pstruct), f"pets_structured not found at {pstruct}"
...
if __name__ == "__main__":
    ...
    ap.add_argument("--out",  default="/home/sunayana/Documents/Concept_LoRA/datasets/pets_features/")
