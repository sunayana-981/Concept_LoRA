...
class ViTSAERunnerConfig:
    ...
    sae_type: str = "standard"        # "standard" | "jumprelu" | "topk"
    topk_k: int = 64                  # number of active features (TopK only)
    jumprelu_bandwidth: float = 0.001 # STE kernel bandwidth (JumpReLU only)
